...
from src.models.ShotDetect import ShotTypeModel
import argparse
...
for root, dirs, files in os.walk(folder_path):
    for file in files:
        ...
        if ext.lower() in [".mp4"]:
            ...
            _ = score_detect.pre_process(video_path)
            ...
            normal_scorebox_info = score_detect.normal_scorebox_info
            ...
            court_dict = {
                ...
                "scorebox_info": normal_scorebox_info,
            }
            ...
            with tqdm(total=total_frames) as pbar:
                ...
                while True:
                    ...
                    have_score_dict = {str(current_frame): have_score}
                    ...
                    if current_frame < next_frame:
                        ...
                        score_dict = {str(current_frame): None}
                        write_json(
                    ...
                    if have_score:
                        have_score_dict = {str(current_frame): True}
                    ...
                    score_dict = {str(current_frame): score_info}
                    write_json(
                        have_score_dict, video_name, f"{result_path}/scores/have_score"
                    )
                    write_json(
                        score_dict, video_name, f"{result_path}/scores/player_score"
                    )
