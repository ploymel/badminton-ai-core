...
for dir in os.listdir(target_directory):
    if os.path.isdir(os.path.join(target_directory, dir)):
        ...
        os.rename(
            os.path.join(target_directory, dir_name),
...
for dir in os.listdir(target_directory):
    ...
    if os.path.isdir(target_path):
        ...
        try:
            ...
            print(
                "Caught exception type on main.py ball_detect:", type(IOError).__name__
            )
        except OSError:
            print(
                "Caught exception type on main.py ball_detect:", type(OSError).__name__
            )
        except Exception:
            print(
                "Caught exception type on main.py ball_detect:",
